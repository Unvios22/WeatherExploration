...
public static class Scenes {
    //config file containing scene names & paths
    ...
    //The initial scene is ran by the engine and thus the SceneLoader doesn't have its data by default; and it's not to be ran again
